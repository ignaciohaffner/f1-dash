	...
	return (
		<div>
			...
			<section className="pb-20">
				...
				<p className="text-md">
					f1-dash is a real-time telemetry and timing dashboard for Formula 1. It allows you to see live timing data
					including lap times, sector times, gaps between drivers, tire choices, and much more.
				</p>
			</section>
		</div>
	);
